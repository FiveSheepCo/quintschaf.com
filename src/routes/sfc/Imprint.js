...
import style from '../scss/Imprint';

const Imprint = () => (
	<div class={style.imprint}>
        <main class={style.content}>
            <h1>Impressum</h1>
            <h2>Angaben gem&auml;&szlig; &sect; 5 TMG</h2>
            <p>
                Marco Quinten und Jann Schafranek GbR (Quintschaf GbR)<br />
                Heinrichstr. 10<br />
                36037 Fulda
            </p>
            <p>
            ...
            <h2>Kontakt</h2>
            <p>
                Telefon: +4915792383286<br />
                E-Mail: legal@quintschaf.com
            </p>
            <h2>
